                ...
                <div className="container">
                    <Grid container alignItems="center">
                        ...
                        <div style={{marginLeft: 6}}>
                            <Typography variant="subtitle1" style={{fontSize: '1.2rem', lineHeight: 1}}>{this.state.user.realName}</Typography>
                            <Typography variant="caption" style={{fontSize: '1rem'}}>{this.state.user.location}</Typography>
                        </div>
                    </Grid>
